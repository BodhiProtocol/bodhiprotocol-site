...
import { ATradeIsMissingWhereDidItBreakBody } from "@/components/ba-playbooks/a-trade-is-missing-where-did-it-break-body";
...
const customPlaybookBodies: Partial<Record<string, () => ReactNode>> = {
  ...
  "a-trade-is-missing-where-did-it-break": ATradeIsMissingWhereDidItBreakBody,
};
