...
import { SmithInvisibleHandDiagram } from "@/components/great-minds/smith-invisible-hand-diagram";
...
import { MurthyFollowTheSunDiagram } from "@/components/great-minds/murthy-follow-the-sun-diagram";
...
import { ConfuciusOrderRingsDiagram } from "@/components/great-minds/confucius-order-rings-diagram";
...
import { LovelaceLoomDiagram } from "@/components/great-minds/lovelace-loom-diagram";
import { LovelaceHeroBackground } from "@/components/great-minds/lovelace-hero-background";
...
const heroDiagrams: Record<string, (mind: GreatMindWithContent) => ReactNode> = {
  ...
  "ada-lovelace": (mind) => <LovelaceLoomDiagram nodes={mind.wheel} />,
};
...
const heroBackgrounds: Record<string, ReactNode> = {
  ...
  "ada-lovelace": <LovelaceHeroBackground />,
};
