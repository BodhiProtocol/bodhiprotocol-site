...
import { GandhiWideningWheelDiagram } from "@/components/great-minds/gandhi-widening-wheel-diagram";
...
const heroDiagrams: Record<string, (mind: GreatMindWithContent) => ReactNode> = {
  ...
  "mahatma-gandhi": (mind) => <GandhiWideningWheelDiagram nodes={mind.wheel} />,
};
