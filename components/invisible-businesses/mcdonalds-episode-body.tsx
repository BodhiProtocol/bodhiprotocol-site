...
import { McdonaldsPageToc } from "@/components/invisible-businesses/mcdonalds-page-toc";
import { McdonaldsRentSplitDiagram } from "@/components/invisible-businesses/mcdonalds-rent-split-diagram";
...
const mdxComponents = { h2: McdonaldsHeading };

function McdonaldsEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
