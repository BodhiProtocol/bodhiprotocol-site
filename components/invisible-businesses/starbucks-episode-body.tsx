...
import { Coffee, Eye, Quote, type LucideIcon } from "lucide-react";
...
import { StarbucksOutcomeSidebar } from "@/components/invisible-businesses/starbucks-outcome-sidebar";
import { StarbucksPageToc } from "@/components/invisible-businesses/starbucks-page-toc";
import { StarbucksThirdPlaceDiagram } from "@/components/invisible-businesses/starbucks-third-place-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-coffee-isnt-the-product": Coffee,
};

function StarbucksHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: StarbucksHeading };

function StarbucksEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
