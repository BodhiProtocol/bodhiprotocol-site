...
import { NikeOutcomeSidebar } from "@/components/invisible-businesses/nike-outcome-sidebar";
import { NikePageToc } from "@/components/invisible-businesses/nike-page-toc";
import { NikeMarginGapDiagram } from "@/components/invisible-businesses/nike-margin-gap-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-shoe-isnt-the-product": Boxes,
};

function NikeHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: NikeHeading };

function NikeEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-margin-gap">
              <NikeMarginGapDiagram />
            </div>
