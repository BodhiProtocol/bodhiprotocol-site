...
const sections = [
  ...
  { id: "why-the-commission-is-the-smaller-business", label: "Why It's More Than Commission" },
  { id: "the-certification-funnel", label: "The Certification Funnel" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function UrbanCompanyPageToc() {
