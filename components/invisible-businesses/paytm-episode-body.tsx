...
import { Eye, Radio, Quote, type LucideIcon } from "lucide-react";
...
import { PaytmOutcomeSidebar } from "@/components/invisible-businesses/paytm-outcome-sidebar";
import { PaytmPageToc } from "@/components/invisible-businesses/paytm-page-toc";
import { PaytmSoundboxAmplifierDiagram } from "@/components/invisible-businesses/paytm-soundbox-amplifier-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-soundbox-isnt-the-business": Radio,
};

function PaytmHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: PaytmHeading };

function PaytmEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-soundbox-amplifier">
              <PaytmSoundboxAmplifierDiagram />
            </div>
