import { Link2, Megaphone, Users } from "lucide-react";

import { Eyebrow } from "@/components/ui/typography";

function Dream11OutcomeSidebar() {
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-brand/15 bg-gradient-to-br from-brand/10 via-card to-transparent p-5">
      ...
      <h3 className="font-heading text-lg leading-snug font-semibold text-balance">
        The Attention That Outlasted The Money
      </h3>
      <p className="text-sm leading-relaxed text-muted-foreground">
        Dream11 lost its prize pools overnight. It kept the one thing advertisers actually pay
        for — millions of people showing up anyway.
      </p>
