...
const sections = [
  ...
  { id: "why-the-prize-money-isnt-the-product", label: "Why The Prize Money Isn't The Product" },
  { id: "the-cliff-the-crowd", label: "The Cliff & The Crowd" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function Dream11PageToc() {
