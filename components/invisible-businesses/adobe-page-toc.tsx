...
const sections = [
  ...
  { id: "why-the-software-isnt-the-product", label: "Why The Software Isn't The Product" },
  { id: "the-collaboration-chain", label: "The Collaboration Chain" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function AdobePageToc() {
