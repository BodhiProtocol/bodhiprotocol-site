...
import { Eye, Wallet, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { CredCreditGateDiagram } from "@/components/invisible-businesses/cred-credit-gate-diagram";
import { CredOutcomeSidebar } from "@/components/invisible-businesses/cred-outcome-sidebar";
import { CredPageToc } from "@/components/invisible-businesses/cred-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-bill-payment-isnt-the-product": Wallet,
};

function CredHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: CredHeading };

function CredEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
