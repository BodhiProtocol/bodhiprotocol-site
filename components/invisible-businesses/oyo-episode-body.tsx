...
import { OyoOutcomeSidebar } from "@/components/invisible-businesses/oyo-outcome-sidebar";
import { OyoPageToc } from "@/components/invisible-businesses/oyo-page-toc";
import { OyoBrandSwapDiagram } from "@/components/invisible-businesses/oyo-brand-swap-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-hotel-disappears": Repeat2,
};

function OyoHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: OyoHeading };

function OyoEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
