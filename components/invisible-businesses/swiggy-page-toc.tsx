...
const sections = [
  ...
  { id: "why-the-order-isnt-the-product", label: "Why The Order Isn't The Product" },
  { id: "the-habit-stack", label: "The Habit Stack" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function SwiggyPageToc() {
