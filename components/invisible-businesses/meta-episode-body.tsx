...
import { MetaAttentionSpiralDiagram } from "@/components/invisible-businesses/meta-attention-spiral-diagram";
import { MetaOutcomeSidebar } from "@/components/invisible-businesses/meta-outcome-sidebar";
import { MetaPageToc } from "@/components/invisible-businesses/meta-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-feed-isnt-the-product": Layers,
};

function MetaHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: MetaHeading };

function MetaEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-attention-spiral">
              <MetaAttentionSpiralDiagram />
            </div>
