...
import { Eye, Percent, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { StripeOutcomeSidebar } from "@/components/invisible-businesses/stripe-outcome-sidebar";
import { StripePageToc } from "@/components/invisible-businesses/stripe-page-toc";
import { StripeFraudGraphDiagram } from "@/components/invisible-businesses/stripe-fraud-graph-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-rate-isnt-the-moat": Percent,
};

function StripeHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: StripeHeading };

function StripeEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-fraud-graph">
              <StripeFraudGraphDiagram />
            </div>
