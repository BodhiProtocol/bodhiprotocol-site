...
import { Eye, Quote, Search, type LucideIcon } from "lucide-react";
...
import { LinkedinOutcomeSidebar } from "@/components/invisible-businesses/linkedin-outcome-sidebar";
import { LinkedinPageToc } from "@/components/invisible-businesses/linkedin-page-toc";
import { LinkedinReachRingsDiagram } from "@/components/invisible-businesses/linkedin-reach-rings-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-network-isnt-the-product": Search,
};

function LinkedinHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: LinkedinHeading };

function LinkedinEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-reach-rings">
              <LinkedinReachRingsDiagram />
            </div>
