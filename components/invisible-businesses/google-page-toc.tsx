...
const sections = [
  ...
  { id: "why-search-isnt-the-product", label: "Why Search Isn't The Product" },
  { id: "the-intent-engine", label: "The Intent Engine" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function GooglePageToc() {
