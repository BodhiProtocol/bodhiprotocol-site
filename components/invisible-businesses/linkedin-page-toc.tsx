...
const sections = [
  ...
  { id: "why-the-network-isnt-the-product", label: "Why The Network Isn't The Product" },
  { id: "the-reach-rings", label: "The Reach Rings" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function LinkedinPageToc() {
