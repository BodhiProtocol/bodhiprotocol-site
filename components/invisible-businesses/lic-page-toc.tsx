...
const sections = [
  { id: "guarantee-chain", label: "The Guarantee Chain" },
  { id: "the-invisible-business", label: "The Invisible Business" },
  { id: "two-promises-one-law", label: "Two Promises, One Law" },
  { id: "why-the-policy-isnt-the-product", label: "Why The Policy Isn't The Product" },
  { id: "the-agent-in-the-room", label: "The Agent In The Room" },
