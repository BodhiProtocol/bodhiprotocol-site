...
const sections = [
  ...
  { id: "why-the-gpu-isnt-the-product", label: "Why The GPU Isn't The Product" },
  { id: "the-free-platform-play", label: "The Free Platform Play" },
  { id: "the-stack", label: "The CUDA Stack" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function NvidiaPageToc() {
