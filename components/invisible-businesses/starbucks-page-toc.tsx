...
const sections = [
  ...
  { id: "why-the-coffee-isnt-the-product", label: "Why The Coffee Isn't The Product" },
  { id: "the-third-place", label: "The Third Place" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function StarbucksPageToc() {
