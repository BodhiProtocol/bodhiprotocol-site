...
import { Eye, Hammer, Quote, type LucideIcon } from "lucide-react";
...
import { IkeaEquationDiagram } from "@/components/invisible-businesses/ikea-equation-diagram";
import { IkeaOutcomeSidebar } from "@/components/invisible-businesses/ikea-outcome-sidebar";
import { IkeaPageToc } from "@/components/invisible-businesses/ikea-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-furniture-isnt-the-product": Hammer,
};

function IkeaHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: IkeaHeading };

function IkeaEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
