...
const sections = [
  ...
  { id: "why-the-listing-isnt-the-product", label: "Why The Listing Isn't The Product" },
  { id: "the-trust-ladder", label: "The Trust Ladder" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function AirbnbPageToc() {
