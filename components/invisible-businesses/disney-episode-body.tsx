...
import { Eye, Film, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { DisneyFranchiseMachineDiagram } from "@/components/invisible-businesses/disney-franchise-machine-diagram";
import { DisneyOutcomeSidebar } from "@/components/invisible-businesses/disney-outcome-sidebar";
import { DisneyPageToc } from "@/components/invisible-businesses/disney-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-movie-isnt-the-product": Film,
};

function DisneyHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: DisneyHeading };

function DisneyEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
