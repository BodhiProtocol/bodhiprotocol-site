...
const sections = [
  ...
  { id: "why-the-movie-isnt-the-product", label: "Why The Movie Isn't The Product" },
  { id: "the-franchise-machine", label: "The Franchise Machine" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function DisneyPageToc() {
