...
import { Eye, ScrollText, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { DmartOutcomeSidebar } from "@/components/invisible-businesses/dmart-outcome-sidebar";
import { DmartPageToc } from "@/components/invisible-businesses/dmart-page-toc";
import { DmartCostTimelineDiagram } from "@/components/invisible-businesses/dmart-cost-timeline-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-it-isnt-just-frugality": ScrollText,
};

function DmartHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: DmartHeading };

function DmartEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-rent-bill-that-never-arrives">
              <DmartCostTimelineDiagram />
            </div>
