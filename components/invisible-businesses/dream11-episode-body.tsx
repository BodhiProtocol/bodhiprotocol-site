...
import { Eye, Trophy, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { Dream11CliffAndCrowdDiagram } from "@/components/invisible-businesses/dream11-cliff-and-crowd-diagram";
import { Dream11OutcomeSidebar } from "@/components/invisible-businesses/dream11-outcome-sidebar";
import { Dream11PageToc } from "@/components/invisible-businesses/dream11-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-prize-money-isnt-the-product": Trophy,
};

function Dream11Heading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: Dream11Heading };

function Dream11EpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-cliff-the-crowd">
              <Dream11CliffAndCrowdDiagram />
            </div>
