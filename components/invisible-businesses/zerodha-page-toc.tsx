...
const sections = [
  ...
  { id: "why-the-free-trade-isnt-the-product", label: "Why The Free Trade Isn't The Product" },
  { id: "the-iceberg", label: "The Iceberg" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function ZerodhaPageToc() {
