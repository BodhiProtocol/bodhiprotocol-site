...
import { GilletteOutcomeSidebar } from "@/components/invisible-businesses/gillette-outcome-sidebar";
import { GillettePageToc } from "@/components/invisible-businesses/gillette-page-toc";
import { GilletteCostSplitDiagram } from "@/components/invisible-businesses/gillette-cost-split-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-razor-isnt-the-product": Boxes,
};

function GilletteHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: GilletteHeading };

function GilletteEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
