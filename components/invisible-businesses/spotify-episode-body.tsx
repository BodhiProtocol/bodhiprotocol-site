...
import { Eye, Music, Quote, type LucideIcon } from "lucide-react";
...
import { SpotifyOutcomeSidebar } from "@/components/invisible-businesses/spotify-outcome-sidebar";
import { SpotifyPageToc } from "@/components/invisible-businesses/spotify-page-toc";
import { SpotifyTasteGraphDiagram } from "@/components/invisible-businesses/spotify-taste-graph-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-songs-arent-the-product": Music,
};

function SpotifyHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: SpotifyHeading };

function SpotifyEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-taste-graph">
              <SpotifyTasteGraphDiagram />
            </div>
