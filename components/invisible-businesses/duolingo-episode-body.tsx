...
import { Eye, GraduationCap, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { DuolingoOutcomeSidebar } from "@/components/invisible-businesses/duolingo-outcome-sidebar";
import { DuolingoPageToc } from "@/components/invisible-businesses/duolingo-page-toc";
import { DuolingoStreakChainDiagram } from "@/components/invisible-businesses/duolingo-streak-chain-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-lesson-isnt-the-product": GraduationCap,
};

function DuolingoHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: DuolingoHeading };

function DuolingoEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-streak-chain">
              <DuolingoStreakChainDiagram />
            </div>
