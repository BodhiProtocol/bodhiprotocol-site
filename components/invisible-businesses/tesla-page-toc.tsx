...
const sections = [
  { id: "credit-timeline", label: "Credit Revenue Over Time" },
  { id: "the-invisible-business", label: "The Invisible Business" },
  { id: "three-credit-markets-one-business", label: "Three Credit Markets, One Business" },
  { id: "the-numbers-behind-the-car", label: "The Numbers Behind The Car" },
  { id: "the-cliff", label: "The Cliff" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function TeslaPageToc() {
