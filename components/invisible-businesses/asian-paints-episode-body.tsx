...
import { AsianPaintsConfidenceDiagram } from "@/components/invisible-businesses/asian-paints-confidence-diagram";
import { AsianPaintsOutcomeSidebar } from "@/components/invisible-businesses/asian-paints-outcome-sidebar";
import { AsianPaintsPageToc } from "@/components/invisible-businesses/asian-paints-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "manufacturing-confidence": ShieldCheck,
  "the-dealer-is-part-of-the-product": Handshake,
  "the-invisible-flywheel": Repeat,
  "why-the-business-keeps-expanding": Home,
  "a-better-way-to-see-businesses": Paintbrush,
};

function AsianPaintsHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: AsianPaintsHeading };

function AsianPaintsEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
