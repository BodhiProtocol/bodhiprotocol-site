...
const sections = [
  ...
  { id: "why-the-soundbox-isnt-the-business", label: "Why The Soundbox Isn't The Business" },
  { id: "the-soundbox-amplifier", label: "The Soundbox Amplifier" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function PaytmPageToc() {
