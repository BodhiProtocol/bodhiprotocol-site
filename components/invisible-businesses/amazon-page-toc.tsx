...
const sections = [
  ...
  { id: "why-the-products-arent-the-product", label: "Why The Products Aren't The Product" },
  { id: "the-confidence-engine", label: "The Confidence Engine" },
  { id: "the-flywheel", label: "The Flywheel" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function AmazonPageToc() {
