...
import { Eye, Layers, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { GoogleIntentEngineDiagram } from "@/components/invisible-businesses/google-intent-engine-diagram";
import { GoogleKeyTakeawaysSidebar } from "@/components/invisible-businesses/google-key-takeaways-sidebar";
import { GoogleOutcomeSidebar } from "@/components/invisible-businesses/google-outcome-sidebar";
import { GooglePageToc } from "@/components/invisible-businesses/google-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-search-isnt-the-product": Layers,
};

function GoogleHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: GoogleHeading };

function GoogleEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-intent-engine">
              <GoogleIntentEngineDiagram />
            </div>
          ...
          <aside className="hidden lg:block">
            <div className="sticky top-24 flex flex-col gap-6">
              <GooglePageToc />
              <GoogleOutcomeSidebar />
              <GoogleKeyTakeawaysSidebar />
            </div>
          </aside>
        </div>
      </Container>
