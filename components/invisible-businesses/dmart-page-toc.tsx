...
const sections = [
  ...
  { id: "why-it-isnt-just-frugality", label: "Why It Isn't Just Frugality" },
  { id: "the-rent-bill-that-never-arrives", label: "The Rent Bill That Never Arrives" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function DmartPageToc() {
