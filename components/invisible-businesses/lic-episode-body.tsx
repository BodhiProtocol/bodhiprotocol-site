...
import { Eye, Landmark, Scale, Users2, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { LicOutcomeSidebar } from "@/components/invisible-businesses/lic-outcome-sidebar";
import { LicPageToc } from "@/components/invisible-businesses/lic-page-toc";
import { LicGuaranteeChainDiagram } from "@/components/invisible-businesses/lic-guarantee-chain-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "two-promises-one-law": Scale,
  "why-the-policy-isnt-the-product": Landmark,
  "the-agent-in-the-room": Users2,
};

function LicHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: LicHeading };

function LicEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
