...
function GilletteOutcomeSidebar() {
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-brand/15 bg-gradient-to-br from-brand/10 via-card to-transparent p-5">
      ...
      <h3 className="font-heading text-lg leading-snug font-semibold text-balance">
        A Socket, Not A Razor
      </h3>
      <p className="text-sm leading-relaxed text-muted-foreground">
        Gillette doesn&apos;t need you to buy a handle twice. It needs you to buy a cartridge
        every few weeks — a refill business wearing a razor as a disguise.
      </p>
