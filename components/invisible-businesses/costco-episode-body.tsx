...
import { CostcoOutcomeSidebar } from "@/components/invisible-businesses/costco-outcome-sidebar";
import { CostcoPageToc } from "@/components/invisible-businesses/costco-page-toc";
import { CostcoProfitSplitDiagram } from "@/components/invisible-businesses/costco-profit-split-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-groceries-arent-the-product": Boxes,
};

function CostcoHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: CostcoHeading };

function CostcoEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-profit-split">
              <CostcoProfitSplitDiagram />
            </div>
