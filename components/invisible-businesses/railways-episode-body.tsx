...
import { Eye, Ticket, Quote, type LucideIcon } from "lucide-react";
...
import { RailwaysCrossSubsidyDiagram } from "@/components/invisible-businesses/railways-cross-subsidy-diagram";
import { RailwaysOutcomeSidebar } from "@/components/invisible-businesses/railways-outcome-sidebar";
import { RailwaysPageToc } from "@/components/invisible-businesses/railways-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-ticket-isnt-the-product": Ticket,
};

function RailwaysHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: RailwaysHeading };

function RailwaysEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-cross-subsidy-ledger">
              <RailwaysCrossSubsidyDiagram />
            </div>
