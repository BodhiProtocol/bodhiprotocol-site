...
const sections = [
  ...
  { id: "why-the-lesson-isnt-the-product", label: "Why The Lesson Isn't The Product" },
  { id: "the-streak-chain", label: "The Streak Chain" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function DuolingoPageToc() {
