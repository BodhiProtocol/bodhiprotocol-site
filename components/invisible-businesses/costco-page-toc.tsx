...
const sections = [
  ...
  { id: "why-the-groceries-arent-the-product", label: "Why The Groceries Aren't The Product" },
  { id: "the-profit-split", label: "The Profit Split" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function CostcoPageToc() {
