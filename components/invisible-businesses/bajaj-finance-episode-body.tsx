...
import { CircleDollarSign, Layers, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { BajajFinanceOutcomeSidebar } from "@/components/invisible-businesses/bajaj-finance-outcome-sidebar";
import { BajajFinancePageToc } from "@/components/invisible-businesses/bajaj-finance-page-toc";
import { BajajFinanceCrossSellDiagram } from "@/components/invisible-businesses/bajaj-finance-cross-sell-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  "the-loan-they-barely-profit-from": CircleDollarSign,
  "the-loans-they-actually-want-you-to-take": Layers,
};

function BajajFinanceHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: BajajFinanceHeading };

function BajajFinanceEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="loan-one-buys-the-data">
              <BajajFinanceCrossSellDiagram />
            </div>
...
export { BajajFinanceEpisodeBody };
