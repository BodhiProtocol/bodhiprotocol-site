...
import { Eye, ShoppingBasket, Quote, type LucideIcon } from "lucide-react";
...
import { ZeptoOutcomeSidebar } from "@/components/invisible-businesses/zepto-outcome-sidebar";
import { ZeptoPageToc } from "@/components/invisible-businesses/zepto-page-toc";
import { ZeptoTenMinuteDialDiagram } from "@/components/invisible-businesses/zepto-ten-minute-dial-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-groceries-arent-the-product": ShoppingBasket,
};

function ZeptoHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: ZeptoHeading };

function ZeptoEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
