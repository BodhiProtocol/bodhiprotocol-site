import { Home, Link2, Star, User } from "lucide-react";

import { Eyebrow } from "@/components/ui/typography";

function AirbnbOutcomeSidebar() {
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-brand/15 bg-gradient-to-br from-brand/10 via-card to-transparent p-5">
      ...
      <p className="text-sm leading-relaxed text-muted-foreground">
        Every booking, Airbnb takes a cut for solving a problem neither side wanted to solve
        alone — trusting a stranger enough to hand over a key.
      </p>
