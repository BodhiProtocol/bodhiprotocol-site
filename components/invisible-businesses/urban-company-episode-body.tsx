...
import { Eye, GraduationCap, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { UrbanCompanyOutcomeSidebar } from "@/components/invisible-businesses/urban-company-outcome-sidebar";
import { UrbanCompanyPageToc } from "@/components/invisible-businesses/urban-company-page-toc";
import { UrbanCompanyCertificationFunnelDiagram } from "@/components/invisible-businesses/urban-company-certification-funnel-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-commission-is-the-smaller-business": GraduationCap,
};

function UrbanCompanyHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: UrbanCompanyHeading };

function UrbanCompanyEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-certification-funnel">
              <UrbanCompanyCertificationFunnelDiagram />
            </div>
...
export { UrbanCompanyEpisodeBody };
