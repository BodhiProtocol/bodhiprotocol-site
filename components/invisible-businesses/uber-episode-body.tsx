...
import { Eye, Quote, Timer, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { UberOutcomeSidebar } from "@/components/invisible-businesses/uber-outcome-sidebar";
import { UberPageToc } from "@/components/invisible-businesses/uber-page-toc";
import { UberAdSlotDiagram } from "@/components/invisible-businesses/uber-ad-slot-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-wait-is-the-product": Timer,
};

function UberHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: UberHeading };

function UberEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
