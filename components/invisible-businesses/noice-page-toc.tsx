...
const sections = [
  ...
  { id: "why-it-isnt-just-another-private-label", label: "Why It Isn't A Private Label" },
  { id: "the-hurdles-noice-skips", label: "The Hurdles It Skips" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function NoicePageToc() {
