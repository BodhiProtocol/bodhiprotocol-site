...
import { Eye, Milk, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { AmulBargainingPyramidDiagram } from "@/components/invisible-businesses/amul-bargaining-pyramid-diagram";
import { AmulOutcomeSidebar } from "@/components/invisible-businesses/amul-outcome-sidebar";
import { AmulPageToc } from "@/components/invisible-businesses/amul-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-milk-isnt-the-product": Milk,
};

function AmulHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: AmulHeading };

function AmulEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-bargaining-pyramid">
              <AmulBargainingPyramidDiagram />
            </div>
