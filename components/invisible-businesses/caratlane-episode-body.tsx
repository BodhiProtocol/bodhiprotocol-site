...
import { Eye, FileCheck2, Home, Repeat, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { CaratlaneOutcomeSidebar } from "@/components/invisible-businesses/caratlane-outcome-sidebar";
import { CaratlanePageToc } from "@/components/invisible-businesses/caratlane-page-toc";
import { CaratlaneConvergenceDiagram } from "@/components/invisible-businesses/caratlane-convergence-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "a-certificate-convinces-the-mind": FileCheck2,
  "why-try-at-home-isnt-a-convenience": Home,
  "the-loop-that-closes-nearby": Repeat,
};

function CaratlaneHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: CaratlaneHeading };

function CaratlaneEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
