...
import { SwiggyOutcomeSidebar } from "@/components/invisible-businesses/swiggy-outcome-sidebar";
import { SwiggyPageToc } from "@/components/invisible-businesses/swiggy-page-toc";
import { SwiggyHabitStackDiagram } from "@/components/invisible-businesses/swiggy-habit-stack-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-order-isnt-the-product": Boxes,
};

function SwiggyHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: SwiggyHeading };

function SwiggyEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-habit-stack">
              <SwiggyHabitStackDiagram />
            </div>
