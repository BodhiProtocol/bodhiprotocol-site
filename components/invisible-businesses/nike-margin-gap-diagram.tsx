...
import { Megaphone, PencilRuler, Sparkles, Factory } from "lucide-react";
...
const loopNodes = [
  { label: "Design & Athletes", icon: PencilRuler },
  { label: "Marketing", icon: Megaphone },
  { label: "Premium Price", icon: Sparkles },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-center gap-2 text-center text-xs text-muted-foreground sm:text-sm">
        ...
        Factories Nike owns. Every shoe is made by someone else.
      </div>
    </div>
  );
}

export { NikeMarginGapDiagram };
