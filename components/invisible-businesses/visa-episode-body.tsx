...
import { Eye, Quote, Repeat2, type LucideIcon } from "lucide-react";
...
import { VisaOutcomeSidebar } from "@/components/invisible-businesses/visa-outcome-sidebar";
import { VisaPageToc } from "@/components/invisible-businesses/visa-page-toc";
import { VisaTrustNetworkDiagram } from "@/components/invisible-businesses/visa-trust-network-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-payment-isnt-the-product": Repeat2,
};

function VisaHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: VisaHeading };

function VisaEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-trust-network">
              <VisaTrustNetworkDiagram />
            </div>
