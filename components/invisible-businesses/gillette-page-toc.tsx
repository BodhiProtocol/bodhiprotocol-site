...
const sections = [
  ...
  { id: "why-the-razor-isnt-the-product", label: "Why The Razor Isn't The Product" },
  { id: "the-cost-split", label: "The Cost Split" },
  { id: "key-takeaways", label: "Key Takeaways" },
];

function GillettePageToc() {
