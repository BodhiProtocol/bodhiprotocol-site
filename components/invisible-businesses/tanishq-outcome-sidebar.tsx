...
function TanishqOutcomeSidebar() {
  return (
    <div className="flex flex-col gap-3 rounded-2xl border border-brand/15 bg-gradient-to-br from-brand/10 via-card to-transparent p-5">
      ...
      <h3 className="font-heading text-lg leading-snug font-semibold text-balance">
        A Reading, Not A Promise
      </h3>
      <p className="text-sm leading-relaxed text-muted-foreground">
        A Karatmeter cost about as much as a small car and told customers nothing they couldn&apos;t
        eventually verify elsewhere — which was the point. Tanishq didn&apos;t ask to be trusted. It
        made trust unnecessary.
      </p>
