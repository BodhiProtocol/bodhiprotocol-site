...
import { Eye, FileCode, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { AdobeCollaborationChainDiagram } from "@/components/invisible-businesses/adobe-collaboration-chain-diagram";
import { AdobeOutcomeSidebar } from "@/components/invisible-businesses/adobe-outcome-sidebar";
import { AdobePageToc } from "@/components/invisible-businesses/adobe-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-software-isnt-the-product": FileCode,
};

function AdobeHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: AdobeHeading };

function AdobeEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="the-collaboration-chain">
              <AdobeCollaborationChainDiagram />
            </div>
