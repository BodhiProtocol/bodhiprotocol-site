...
import { Eye, Wifi, Quote, type LucideIcon } from "lucide-react";
...
import { JioBurnCurveDiagram } from "@/components/invisible-businesses/jio-burn-curve-diagram";
import { JioOutcomeSidebar } from "@/components/invisible-businesses/jio-outcome-sidebar";
import { JioPageToc } from "@/components/invisible-businesses/jio-page-toc";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "why-the-data-plan-isnt-the-product": Wifi,
};

function JioHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: JioHeading };

function JioEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
