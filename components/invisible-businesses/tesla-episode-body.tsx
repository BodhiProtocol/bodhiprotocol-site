...
import { BarChart3, Eye, Globe2, Quote, TrendingDown, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { TeslaOutcomeSidebar } from "@/components/invisible-businesses/tesla-outcome-sidebar";
import { TeslaPageToc } from "@/components/invisible-businesses/tesla-page-toc";
import { TeslaCreditTimelineDiagram } from "@/components/invisible-businesses/tesla-credit-timeline-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "three-credit-markets-one-business": Globe2,
  "the-numbers-behind-the-car": BarChart3,
  "the-cliff": TrendingDown,
};

function TeslaHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: TeslaHeading };

function TeslaEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
        <div className="grid gap-12 lg:grid-cols-[1fr_280px]">
          <article className="flex min-w-0 flex-col gap-10">
            ...
            <div id="credit-timeline">
              <TeslaCreditTimelineDiagram />
            </div>
