...
import { Eye, ScanLine, TrendingUp, Repeat, Quote, type LucideIcon } from "lucide-react";
import { MDXRemote } from "next-mdx-remote/rsc";

import { TanishqOutcomeSidebar } from "@/components/invisible-businesses/tanishq-outcome-sidebar";
import { TanishqPageToc } from "@/components/invisible-businesses/tanishq-page-toc";
import { TanishqPurityDiagram } from "@/components/invisible-businesses/tanishq-purity-diagram";
...
const headingIcons: Record<string, LucideIcon> = {
  ...
  "a-test-anyone-could-watch": ScanLine,
  "why-the-jewelry-isnt-the-product": TrendingUp,
  "the-loop-that-keeps-closing": Repeat,
};

function TanishqHeading({ id, children }: ComponentProps<"h2">) {
...
const mdxComponents = { h2: TanishqHeading };

function TanishqEpisodeBody({ episode }: { episode: InvisibleBusinessWithContent }) {
  return (
    <Section>
      <Container>
