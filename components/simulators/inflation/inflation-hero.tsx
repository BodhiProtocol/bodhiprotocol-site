...
interface InflationHeroProps {
  diagram: ReactNode;
}

function InflationHero({ diagram }: InflationHeroProps) {
  return (
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-md font-serif text-xl text-balance text-muted-foreground sm:text-2xl">
              Why do interest rates, money, and productivity pull the economy in different directions?
            </p>
          </div>

          <div className="h-px w-16 bg-border" />

          <p className="max-w-sm text-muted-foreground">Move the sliders and watch the tradeoffs play out.</p>
