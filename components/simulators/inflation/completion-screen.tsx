...
const RELATED_MENTAL_MODELS = [
  {
    name: "Stagflation",
    description: "When inflation and unemployment rise together, breaking the usual tradeoff.",
  },
  {
    name: "Phillips Curve",
    description: "The classic — and contested — tradeoff between inflation and unemployment.",
  },
  {
    name: "Quantitative Easing",
    description: "How central banks expand the money supply without printing physical cash.",
  },
  {
    name: "Real vs. Nominal Growth",
    description: "Why growth numbers mean nothing until you adjust for inflation.",
  },
];
  ...
  return (
    <GlassCard className="items-center gap-8 p-8 text-center sm:p-12">
      <div className="flex flex-col items-center gap-4">
        ...
        <H2>You now understand Inflation</H2>
      </div>
