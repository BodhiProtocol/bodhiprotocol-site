...
function FlywheelHero({ diagram }: FlywheelHeroProps) {
  return (
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-md font-serif text-xl text-balance text-muted-foreground sm:text-2xl">
              How do reinforcing loops compound small advantages into big ones?
            </p>
          </div>
          ...
          <p className="max-w-sm text-muted-foreground">
            Move the sliders and watch whether the loop keeps itself spinning — or grinds to a halt.
          </p>
