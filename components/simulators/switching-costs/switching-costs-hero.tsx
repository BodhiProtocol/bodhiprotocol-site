...
interface SwitchingCostsHeroProps {
  diagram: ReactNode;
}

function SwitchingCostsHero({ diagram }: SwitchingCostsHeroProps) {
  return (
        ...
        >
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-md font-serif text-xl text-balance text-muted-foreground sm:text-2xl">
              Why does leaving a product get harder the longer you use it?
            </p>
          </div>
          ...
          <p className="max-w-sm text-muted-foreground">
            Move the sliders and watch how much it would cost to walk away.
          </p>
