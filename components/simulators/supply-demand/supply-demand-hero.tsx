...
interface SupplyDemandHeroProps {
  diagram: ReactNode;
}

function SupplyDemandHero({ diagram }: SupplyDemandHeroProps) {
  return (
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="max-w-md font-serif text-xl text-balance text-muted-foreground sm:text-2xl">
              Why does price settle exactly where buyers and sellers agree?
            </p>
          </div>

          <div className="h-px w-16 bg-border" />

          <p className="max-w-sm text-muted-foreground">Move the sliders and watch the price find its balance.</p>
