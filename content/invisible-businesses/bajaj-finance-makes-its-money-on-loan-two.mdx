...
insights:
  ...
  - icon: "🔁"
    text: "As of Q1 FY26, the average Bajaj Finance customer held 2.94 lending products and 6.04 products overall — cross-sold off an installed base of 115 million+ customers, roughly 74 million of whom already sit inside its pre-approved cross-sell franchise."
  - icon: "💰"
...
nextEpisode:
  title: "The Rent DMart Never Pays"
  slug: "the-rent-dmart-never-pays"
---
...
Once that first EMI is behaving the way Bajaj hoped, the second offer shows up — a personal loan, a higher credit limit, an EMI card, an insurance policy bundled in. This is where the actual interest income lives, and Bajaj is very good at getting there: as of Q1 FY26, the average customer held 2.94 lending products, not one, and 6.04 products overall — cross-sold off an installed base north of 115 million customers, roughly 74 million of whom already sit inside Bajaj's pre-approved cross-sell franchise.
