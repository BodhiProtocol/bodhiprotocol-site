...
const bodyText = `Sprint 1: arrastada. Sprint 2: arrastada. Sprint 3: arrastada. Segunda de manhã. Sprint 4. E lá está ela de novo. ABC-142. Mesmo título. Mesma pontuação de story. Mesma sensação levemente incômoda quando alguém pergunta "o que falta nessa aí?" Alguém diz "está quase pronta". O que é interessante, porque também estava quase pronta há três semanas. Nesse ponto, eu não perguntaria "como a gente termina essa story?" Eu perguntaria "por que essa story sobreviveu quatro sprints?" Porque uma story que fica sendo arrastada geralmente está te dizendo alguma coisa. O erro é tratar o próprio arrasto como o problema.
