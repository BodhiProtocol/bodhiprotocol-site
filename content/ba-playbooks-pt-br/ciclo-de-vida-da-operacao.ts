...
export const cicloDeVidaDaOperacao: Omit<Playbook, "readingTime"> = {
  ...
  summary:
    "Um passo a passo de uma operação, da Ordem à Liquidação — Ordem, Execução, Enriquecimento e Confirmação, Compensação, Liquidação — com o que acontece em cada etapa, onde os requisitos quebram silenciosamente, e um checklist de etapas gratuito.",
  category: "Capital Markets",
  tags: ["Ciclo de Vida da Operação", "Mercado de Capitais", "Liquidação"],
  author: "Surya",
  date: "2026-09-01",
  itemLabel: "Etapa",
  intro: [
    "Seu gestor diz que a mudança está \"na etapa de liquidação\". Você assente com a cabeça. Mas, na verdade, não sabe quantas etapas vêm antes da liquidação, nem o que acontece em cada uma — então não consegue dizer se essa mudança realmente pertence ali.",
  ...
  seoDescription:
    "As cinco etapas de uma operação — Ordem, Execução, Enriquecimento e Confirmação, Compensação e Liquidação — explicadas passo a passo para BAs, com checklist gratuito.",
  ...
  hacks: [
    ...
    },
    {
      ...
      compare: {
        ...
        rightLabel: "Operação",
        right: "A execução realmente casada. Uma ordem pode gerar várias operações se for executada em partes.",
      },
    ...
    },
    {
      ...
      whyItHelps: "Se um requisito assume que \"uma ordem é igual a uma operação\", ele vai processar incorretamente, e em silêncio, toda ordem executada parcialmente — o que, em uma mesa ativa, é a maioria delas.",
    },
    {
      number: 4,
    ...
    },
    {
      ...
      whyItHelps: "\"Operação concluída\" numa tela de front-end geralmente significa executada, não liquidada — e o intervalo entre as duas pode ser um dia inteiro ou mais, exatamente a janela onde moram as falhas de liquidação.",
    },
    {
      number: 7,
    ...
    },
    {
      ...
      whyItHelps: "Fazer essas perguntas antes de escrever ou revisar um requisito pega uma lacuna de escopo antes que um desenvolvedor construa algo com base na etapa errada.",
    },
  ],
};
