...
hook: "Two fields on the exact same FIX message answer two completely different questions — and conflating them is the single most common mistake a new BA makes reading an execution report."
