...
Three ordinary things happen in one ordinary week.

A grandfather lends his nephew ₹500, on the understanding that he'll get ₹520 back next month — a little extra for the favour. A father comes home from a work trip to the US with $40 left in his wallet and swaps it for rupees at the airport counter. And the man running the wheat stall down the road is nervously watching the news, because if wheat gets expensive before the festival season, he's the one who eats the loss.

A loan. A currency swap. A worry about the price of a crop.

Three completely unrelated problems, if you're the grandfather, the father, or the wheat seller. Walk into a bank's trading floor, though, and you'll find one single business built to handle all three — because underneath the ₹20 rice bags, they're the same problem wearing different clothes.

That business has a name almost nobody outside banking has heard: **FICC.**

Aditi first met that word on a quarterly reporting deck — a slide summarising a bank's trading floor for the quarter. One line read **FICC revenue: up 9% year-on-year.** Nobody in the room ever asked what was actually inside that number. They just wanted to know if it went up.

Aditi knew it wasn't one business. It was four or five different trading desks, each pricing a completely different kind of risk — a loan, a currency, a crop — filed under one four-letter acronym because Wall Street needed a shorter word than "everything-that-isn't-shares."
...
Say the full name slowly and it stops being mysterious. It's the grandfather, the father and the wheat seller, wearing bank uniforms.

**Fixed Income** — the grandfather's loan, at bank scale. Bonds and loans: money lent to a government or company in exchange for a fixed schedule of payments. Covered in detail in [Bonds: The Fixed Deposit You Can Sell](/essays/bonds-the-fixed-deposit-you-can-sell).

**Currencies** — the father's airport counter, at bank scale. Foreign exchange, or FX: the market where one country's money is exchanged for another's.

**Commodities** — the wheat seller's worry, at bank scale. Physical goods traded as financial contracts: oil, gold, natural gas, wheat, copper.
