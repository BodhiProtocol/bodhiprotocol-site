...
This is what "naked" CDS means, and it's the entire reason the market grew far larger than the debt it referenced. Ahead of the 2008 crisis, hedge funds that owned none of the underlying subprime mortgage bonds bought CDS protection against them anyway, in size — a bet that the bonds would fail, paid for at a fraction of what shorting the bonds directly would have cost. When the bonds did fail, the payouts owed on those contracts had nothing to do with any real loss on any real bond someone actually held. The insurance metaphor breaks down exactly there: a real insurer's total payout is capped by the value of the property that actually exists. A CDS market's total payout is capped only by how many contracts two willing parties agreed to write.
