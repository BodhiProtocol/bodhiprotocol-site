...
None of the above touches the largest share of retail F&O activity in India at all — because most of it isn't leveraged futures or margin-traded stock. It's buying options. An analysis of the exchanges' own turnover data found that 76% of individual options traders never once traded a single stock option, running their entire F&O activity through weekly Nifty and Bank Nifty index contracts instead — and roughly 97% of that index-options turnover happens within the final week before expiry.

An option buyer's loss looks nothing like a margin call. [The buyer's worst case is capped at the premium paid, full stop](/essays/options-the-right-to-walk-away) — there's no RMS, no forced square-off, no debit balance. But that cap doesn't mean the odds are even. [A premium decays a little every single day the position is held](/essays/theta-the-cost-of-being-right-too-late), whether the price moves or not — so a buyer isn't just betting on direction. They're betting the move happens far enough, and fast enough, to outrun a cost that's ticking down regardless. Buy a contract expiring in three days, guess the direction correctly, and still lose money, because the move wasn't large enough to clear the premium and decay combined before expiry arrived.
...
Two products, two countries, two different loss mechanisms tangled together inside each number — and in both places, regulators looked at the data and concluded the same large majority of retail participants were losing.
