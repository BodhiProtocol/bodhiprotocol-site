...
Think of a heron standing motionless at the edge of a pond for a long stretch, doing nothing that looks like fishing at all — until one specific ripple appears, and it strikes in a single, decisive motion. It wasn't idle the whole time. It was waiting for the one condition that made striking worthwhile.

A sniper algorithm trades the same way.
