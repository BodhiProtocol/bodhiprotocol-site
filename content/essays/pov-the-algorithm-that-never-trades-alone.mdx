...
Think of a rickshaw driver at the front of a stand who has made himself a private rule: take exactly one out of every ten passengers who show up, whatever the hour. On a busy morning, that means many rides, one after another. On a slow afternoon, it means almost none. He never sets a target for the day — only a fixed share of whatever traffic actually arrives.

A POV algorithm runs the same rule against a stock's trading volume.
