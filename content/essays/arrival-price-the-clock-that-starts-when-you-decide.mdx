...
seoTitle: "Arrival Price Explained: The Clock That Starts When You Decide"
seoDescription: "Arrival price measures execution quality against the price the moment you decided to trade, not the market average like VWAP. A plain-English guide to the arrival price algorithm and how it's used to judge trading strategy."
...
Think of calling for a cab the moment you decide to leave the house. The fare that should count isn't whatever the app quotes when the driver finally shows up ten minutes later — it's the fare at the exact minute you made the call. Every minute between deciding and departing is its own cost, separate from the ride itself.

A trading desk measures the same gap, in rupees instead of minutes.
