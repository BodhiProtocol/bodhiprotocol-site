...
On November 10, 2025, the UK's Office of Financial Sanctions Implementation fined Bank of Scotland £160,000 for processing 24 payments, totalling more than £77,000, into and out of a personal account belonging to Dmitrii Ovsyannikov — a person designated under the UK's Russia sanctions regime. The screening system wasn't blind to Ovsyannikov's name; it just didn't register a transliteration variant of it as the same real person the sanctions list had already named. The system worked exactly as built. It just wasn't built to catch that particular spelling. It's the same category of gap OFAC found at Deutsche Bank Trust Company Americas, which agreed to pay two penalties totalling $583,100 in a September 9, 2020 settlement after processing a $28.8 million transfer tied to a sanctioned Cyprus-based oil trading firm — caused, OFAC's own enforcement release said, by a screening tool calibrated to return only exact matches, at a bank that could clearly afford better. Same root failure as the UK case, just self-inflicted through a filter setting instead of an accident of transliteration — a screening system checking for exact spellings in a world where exact spellings are the exception, not the rule.
...
- [OFAC: Enforcement Release — Deutsche Bank Trust Company Americas (September 9, 2020)](https://ofac.treasury.gov/media/47956/download)
