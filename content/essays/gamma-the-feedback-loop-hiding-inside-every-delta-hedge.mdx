...
description: "GameStop rose from $19.95 to an intraday high of $483 in eleven trading days in January 2021 — a move popularly blamed on a gamma squeeze, even though the SEC's own 2021 staff report found the options data didn't clearly support that story. Gamma measures how fast delta itself changes, and it's highest exactly where a market maker's hedging turns from a stabilizing force into an accelerant. What gamma actually measures, who has to react to it fastest, and why the same mechanic shows up in India not as a headline crash but as a quiet, routine pull toward one strike price every single expiry — with paired Indian and international examples throughout."
hook: "GameStop rose 2,321% in eleven trading days in 2021, widely blamed on a 'gamma squeeze' — except the SEC's own investigation found the options data didn't clearly back that story."
...
India hasn't had its own GameStop. Its version of the same mechanic isn't a headline crash — it's a quiet pull, visible every single week. Because gamma peaks for options sitting at the strike price with little time left, and because large option writers hedge in whatever direction keeps their own exposure smallest, Nifty and Bank Nifty have long shown a documented tendency to drift toward a "max pain" strike — the level at which the largest number of outstanding options expire worthless — in the final hours before a weekly expiry, a pattern Zerodha's own trader-education material, Varsity, describes and teaches retail traders to watch for. SEBI took that expiry-day concentration seriously enough to act on the market structure around it directly: from September 2025, NSE and BSE were required to move their weekly index expiries to separate days — NSE to Tuesday, BSE to Thursday — specifically to stop expiry-day options activity from clustering into a single, more volatile session across both exchanges at once.

Same mechanism, two different shapes: a single, contested eleven-day spike in the US that regulators are still debating the size of, and a routine, low-drama pull toward one number that shows up on NSE nearly every week and just needed the exchanges kept a day apart.
