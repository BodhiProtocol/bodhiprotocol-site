...
## Why this is different from options and futures

An option was a capped choice. A futures contract was a symmetric obligation, settled daily, on a real position. A swap is neither.
...
Options and futures both reference something that trades. A swap's notional doesn't have to reference anything that ever changes hands at all.
